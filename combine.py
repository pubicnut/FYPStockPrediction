...
def main():
    pages = {
        "Prediction": page_home,
        "Technical Analysis": page_settings,
    }
...
def page_home():
    ...
    user_input = st.sidebar.text_input("ENTER STOCK SYMBOL", key="text")
    ...
    end_date = st.sidebar.date_input("End date",
                                     datetime.date(2021, 12, 22))  # remember to change to datetime.date.today()
    ...
    def prediction_test():
        ...
        for i in range(60,
                       entry_count):  # 60 because take data from day 1 to day 60, then making predicition on 61st day. #
